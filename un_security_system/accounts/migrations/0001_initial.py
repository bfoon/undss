    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('data_entry', 'Data Entry (Security Guard)'), ('lsa', 'Local Security Associate'), ('soc', 'Security Operations Center')], default='data_entry', max_length=20)),
